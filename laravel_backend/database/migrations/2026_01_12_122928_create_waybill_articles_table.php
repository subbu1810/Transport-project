...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('waybill_articles')) {
            Schema::create('waybill_articles', function (Blueprint $table) {
                ...
                $table->decimal('dd_rate', 15, 2)->default(0);
                $table->decimal('dd_total', 15, 2)->default(0);
                $table->decimal('handling_rate', 10, 2)->default(0);
                $table->decimal('handling_total', 12, 2)->default(0);
                $table->decimal('dd_charges', 10, 2)->default(0);
                $table->decimal('stationary_charges', 10, 2)->default(0);
