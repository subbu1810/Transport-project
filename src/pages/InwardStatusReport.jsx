...
function InwardStatusReport() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-3xl font-bold text-gray-800">Inward Status Report</h1>

      <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
        <div className="bg-green-50 p-6 rounded-lg border-2 border-green-300">
          <h3 className="font-bold text-gray-800 mb-4">Search Inward Waybill Details</h3>
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-2 border-yellow-200">
          <h3 className="font-bold text-gray-800 mb-4">Inward Waybill Details View</h3>
          <div className="flex gap-2 mb-4">
            ...
            <button className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold">ExportToExcel</button>
          </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-yellow-100 border-b-2 border-yellow-300">
                <tr>
                  ...
                  <th className="px-3 py-2 text-left font-semibold">Inward Date</th>
                  ...
                  <th className="px-3 py-2 text-left font-semibold">ToPay</th>
                  <th className="px-3 py-2 text-left font-semibold">Account</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b hover:bg-gray-50">
                  <td colSpan="14" className="px-3 py-2 text-center text-gray-500">No data</td>
                </tr>
              </tbody>
            </table>
          </div>
