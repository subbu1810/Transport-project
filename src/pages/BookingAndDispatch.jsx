...
function BookingAndDispatch() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-3xl font-bold text-gray-800">Booking And Dispatch</h1>

      <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
        <div className="bg-green-50 p-6 rounded-lg border-2 border-green-300">
          <h3 className="font-bold text-gray-800 mb-4">Booking And Dispatch Details</h3>
        ...
        <div className="bg-green-50 p-6 rounded-lg border-2 border-green-300">
          <div className="flex gap-2 mb-4">
            <button className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold">Booking Graph</button>
            <button className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold">Booking & Inward Details</button>
          </div>
          <div className="bg-black p-4 rounded mb-4">
            <p className="text-white font-semibold">TOTAL BOOKING:</p>
            <p className="text-white font-semibold">TOTAL INWARD:</p>
          </div>
        </div>

        <div className="bg-green-50 p-6 rounded-lg border-2 border-green-300">
          <h3 className="font-bold text-gray-800 mb-4">BRANCH BOOKING DETAILS</h3>
        ...
        <div className="bg-green-50 p-6 rounded-lg border-2 border-green-300">
          <h3 className="font-bold text-gray-800 mb-4">BRANCH AUTO INWARD DETAILS</h3>
          <div className="h-32 bg-gray-100 rounded flex items-center justify-center">
            <p className="text-gray-500">Inward Details</p>
          </div>
        </div>
      </div>
    </div>
