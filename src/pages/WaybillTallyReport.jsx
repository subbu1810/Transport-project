...
function WaybillTallyReport() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-3xl font-bold text-gray-800">WayBill Tally Report</h1>
            ...
            <table className="w-full text-sm">
              <thead className="bg-yellow-100 border-b-2 border-yellow-300">
                <tr>
                  ...
                  <th className="px-3 py-2 text-left font-semibold">Consignor Name</th>
                  <th className="px-3 py-2 text-left font-semibold">GST No</th>
                  <th className="px-3 py-2 text-left font-semibold">Consignee Name</th>
