...
function ConsignorReportReports() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-3xl font-bold text-gray-800">Consignor Report</h1>

      <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
        <div className="bg-green-50 p-6 rounded-lg border-2 border-green-300">
          <h3 className="font-bold text-gray-800 mb-4">Consignor Waybill Report</h3>
          <div className="grid grid-cols-5 gap-4">
            ...
            <div>
              ...
              <select value={filters.consignor} onChange={(e) => setFilters({...filters, consignor: e.target.value})} className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg bg-pink-50">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border-2 border-yellow-200">
          ...
          <div className="flex gap-2 mb-4">
            ...
            <button className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold">Unload Ack</button>
            <button className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold">View Ack</button>
          </div>
...
export default ConsignorReportReports
